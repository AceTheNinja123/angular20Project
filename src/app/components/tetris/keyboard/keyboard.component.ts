...
import { ArrowButton } from '@app/tetris/interface/ui-model/arrow-button';
import { KeyboardService } from '@app/tetris/state/keyboard/keyboard.service';
...
@Component({
  ...
  styleUrls: ['./keyboard.component.scss', '../../../tetris/styles/tetris.scss'],
